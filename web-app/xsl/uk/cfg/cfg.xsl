...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="resourcefile" select="document('../../../cfg/uk/resource.xml')"/>
    <xsl:variable name="messagefile" select="document('../../../cfg/uk/messages.xml')"/>

    <!-- loaded from main xsls - hence different path -->
    <xsl:variable name="local-config-path" select="'../../cfg/uk/'"/>
    ...
    <!-- determine whether links displayed on uk site-->
    <xsl:variable name="primarysourceon" select="document('../../../cfg/psconfig.xml')/psconfig/uklinkson"/>
