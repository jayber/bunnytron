<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="recipe">
        <div id="body">
            ...
            <div id="acknowledgement">
                <div class="ack christmas">background image provided by
                    <a href="http://www.flickr.com/people/thefrog/" target="_blank">the Frog</a>
                </div>
                <div class="ack breakfast">background image provided by
                    <a href="http://www.ronvanzon.nl" target="_blank">Ron van Zon</a>
                </div>
                <div class="ack dinner">background image provided by
                    <a href="http://www.tupwanders.nl/" target="_blank">Tup Wanders</a>
                </div>
                <div class="ack picnic">background image provided by
                    <a href="http://www.ronvanzon.nl">Ron van Zon</a>
                </div>
            </div>
    ...
    <xsl:template match="tips">
        <xsl:if test="$xopus='true'">
            <xsl:if test="@hidden='true'">
                <div class="showTips unhover-showTips morph" onclick="node.setAttribute('hidden', 'false');">Show Tips
                </div>
            </xsl:if>
        </xsl:if>
    ...
    <xsl:template match="nutrition">
        <xsl:if test="$xopus='true'">
            <xsl:if test="@hidden='true'">
                <div class="showNutrition unhover-showNutrition morph" onclick="node.setAttribute('hidden', 'false');">
        ...
        <div id="nutrition">
            ...
            <xsl:if test="$xopus='true'">
                <div class="button-close morph" onclick="node.setAttribute('hidden', 'true');"
                     title="Hide Nutrition Facts"></div>
            </xsl:if>
            <div class="box-canvas">
