...
$.G$ = {
    ...
    Ma: function (w$, Qa, na, ub, La) {
        ...
        if (ub < Ga.length - 1)
            $.l$.m$(function () {
                vb.Ma(w$, Ka, na, ub + 1, La);
            }, data.r$);
        else
            $.l$.m$(function () {
                if (vb.contains(w$, Ka))vb.replace(w$, Ka, na, La, true);
            }, data.r$);
    },
...
$.wk = {
    ...
    _$: function () {
        var vb = this;
        $.yc.Jc([this.xk + "up"], [this.xk], function (Wc, bb, Xc, Bd) {
            vb.Ak(Xc, -$.l$.V$(Wc, vb.xk + "-up", 1, true), 0);
        });
        $.yc.Jc([this.xk + "down"], [this.xk], function (Wc, bb, Xc, Bd) {
            vb.Ak(Xc, $.l$.V$(Wc, vb.xk + "-down", 1, true), 0);
        });
        $.yc.Jc([this.xk + "left"], [this.xk], function (Wc, bb, Xc, Bd) {
            vb.Ak(Xc, 0, -$.l$.V$(Wc, vb.xk + "-left", 1, true));
        });
        $.yc.Jc([this.xk + "right"], [this.xk], function (Wc, bb, Xc, Bd) {
            vb.Ak(Xc, 0, $.l$.V$(Wc, vb.xk + "-right", 1, true));
        });
...
$.Re = {
    ...
    mf: function (Y) {
        return Y.replace(/([A-Z])/g, function (yf) {
            return "-" + yf.toLowerCase();
        });
    },
    zf: {
    ...
    animate: function (Cf, Df) {
        ...
        for (var i = 0; i < Ef; i++) {
            ...
            for (var Pf in Of) {
                var Qf = Pf;
                if (!$.Q)
                    Qf = Pf.replace(/([A-Z])/g, function (yf) {
                        return "-" + yf.toLowerCase();
                    });
