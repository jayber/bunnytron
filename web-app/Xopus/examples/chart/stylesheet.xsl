...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="1.0">
        ...
        <div align="center">
            <table border="0" width="{@width}%">
                ...
                <xsl:attribute name="class">
                    <xsl:choose>
                        <xsl:when test="@color">color_
                            <xsl:value-of select="@color"/>
                        </xsl:when>
                        <xsl:otherwise>color_grey</xsl:otherwise>
                    </xsl:choose>
                    <xsl:choose>
                        <xsl:when test="@border">border_
    ...
    <xsl:template match="chart">
        ...
        <svg style="float:right; margin-right: 3em; margin-top: -4em" width="400px" height="400px"
             viewBox="-1.2 -1.2 2.4 2.4" version="1.1" xmlns="http://www.w3.org/2000/svg">
