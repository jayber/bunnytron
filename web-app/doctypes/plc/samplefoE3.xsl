...
-->
    ...
    <xsl:param name="ismaintained">
        <xsl:value-of select="/*/metadata/maintained"/>
    </xsl:param>
                ...
                <fo:block>
                    <xsl:variable name="img_fullpath">
                        <xsl:choose>
                            ...
                            <xsl:when test="contains(attribute::fileref,'binaryContent.jsp?item=:')">
                    ...
                    <xsl:variable name="img_relpath">
                        <xsl:choose>
                            <xsl:when test="contains($img_fullpath,'.')">
                    ...
                    <xsl:variable name="img_extension">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>tif</xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
     ...
     <fo:table-body>
      <fo:table-row>
        <fo:table-cell>-->
            ...
            <xsl:if test="not ($ismaintained='true')">
                <fo:block>
                    <xsl:call-template name="make-block">
                        <xsl:with-param name="blockstyle">Body</xsl:with-param>
                    </xsl:call-template>
...
-->
        <fo:block>
            ...
            &#169; Legal &amp; Commercial Publishing Limited 1990 - 2007. http://www.practicallaw.com.
        </fo:block>
        <xsl:choose>
            <xsl:when test="$type='Skills Checklist'">
                <fo:block>
            ...
            <xsl:otherwise>
                ...
                <fo:block>
                    ...
                    <!--To access the document on our site type in www.practicallaw.com followed by a forward slash and the plc reference id (e.g. www.practicallaw.com/9-204-5083) in your browser. -->
                </fo:block>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
